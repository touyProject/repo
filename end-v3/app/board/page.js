...
const page = () => {
    ...
    return (
        ...
        <div className='flex flex-col m-4 items-center justify-center h-screen'>
            <div><p className='text-6xl text-gray-900 mb-4'>전체 게시판</p></div>
            {/*서치 박스*/}
    ...
    <div>
        <button
            type="submit"
            className="ml-3 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
